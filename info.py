...
# Assign FQDN based on environment variables and conditions
FQDN = str(getenv('FQDN', BIND_ADRESS)) if (not ON_HEROKU or getenv('FQDN')) else ((APP_NAME or '') + '.herokuapp.com')
URL = "https://testzno-f6087b8c0b5b.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://testzno-f6087b8c0b5b.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://testzno-f6087b8c0b5b.herokuapp.com/".format(FQDN)
else:
    URL = "https://testzno-f6087b8c0b5b.herokuapp.com/".format(FQDN)
